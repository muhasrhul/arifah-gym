            ...
            Filament::pushMeta([
                ...
                <style>
                    ...
                    @media (max-width: 768px) {
                        ...
                        /* Hide navigation saat sidebar terbuka */
                        .filament-sidebar-open #mobile-bottom-nav,
                        body.sidebar-open #mobile-bottom-nav,
                        body:has(.filament-sidebar-open) #mobile-bottom-nav,
                        body:has([x-data*="sidebar"][x-data*="true"]) #mobile-bottom-nav,
                        body:has(aside[class*="translate-x-0"]:not([class*="-translate-x"])) #mobile-bottom-nav {
                    ...
                    document.addEventListener("DOMContentLoaded", function() {
                        ...
                        nav.querySelectorAll("a").forEach(function(a) {
                            if (a.getAttribute("href") === path || 
                                (path.startsWith(a.getAttribute("href")) && a.getAttribute("href") !== "/admin")) {
                        ...
                        function checkSidebarState() {
                            var sidebar = document.querySelector("aside.filament-sidebar");
                            var sidebarOpen = false;

                            if (sidebar) {
                                // Check if sidebar has translate-x-0 (open) or -translate-x-full (closed)
                                var classes = sidebar.className;
                                sidebarOpen = classes.includes("translate-x-0") && !classes.includes("-translate-x");
                            }
                        ...
                        // Listen for clicks on sidebar toggle button
                        document.addEventListener("click", function(e) {
                            if (e.target.closest("[x-data]") || e.target.closest("button")) {
                                setTimeout(checkSidebarState, 100);
                            }
                        });
                    });
