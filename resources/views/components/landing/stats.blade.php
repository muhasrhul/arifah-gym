        ...
        <div class="max-w-6xl mx-auto px-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-1 bg-[#0992C2] rounded-2xl md:rounded-[2.5rem] overflow-hidden shadow-2xl shadow-[#0992C2]/20">
                ...
                <div class="bg-[#0992C2] p-6 md:p-8 flex flex-col items-center justify-center text-white">
                    <span class="text-xl md:text-2xl font-black mb-1 leading-tight text-center italic uppercase">MAKASSAR</span>
                    <p class="text-[9px] md:text-[10px] font-bold uppercase tracking-widest opacity-80 italic text-center">Jln Skarda N, No.13</p>
                </div>
            </div>
        </div>
    </section>